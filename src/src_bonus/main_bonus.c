...
/*   Updated: 2024/12/02 16:06:52 by sinawara         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	execute_command(t_args_bonus *args_bonus, int cmd_idx, char **env,
		char **argv)
{
	int	infile;
	int	outfile;
...
static void	create_pipes_and_forks(t_args_bonus *args_bonus, char **argv,
		char **env)
{
	int		i;
	pid_t	pid;
